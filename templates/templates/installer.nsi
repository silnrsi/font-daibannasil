...
!define INSTALL_SUFFIX "SIL\Fonts\@titlecase $(PRODUCT_WIN)@"
...
;Pages
  ...
  @and $(LICENSE),!insertmacro MUI_PAGE_LICENSE "$(osslash $(LICENSE))"@
...
Section -StartMenu
  @and $(README),File "$(osslash $(README))"@
  @and $(LICENSE),File "$(osslash $(LICENSE))"@
  @and $(FONTLOG),File "$(osslash $(FONTLOG))"@
